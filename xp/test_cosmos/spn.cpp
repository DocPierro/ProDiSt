...
const int _nb_Place_start=2;
const int _nb_Place_p3=3;
const int _nb_Place_p4=4;
const int _nb_Place_end=5;
const int _nb_Place_p6=6;
...
int abstractMarking::getNbOfTokens(int p)const {
	switch (p) {
		...
		case 2: return P->_PL_start;
		case 3: return P->_PL_p3;
		case 4: return P->_PL_p4;
		case 5: return P->_PL_end;
		case 6: return P->_PL_p6;
...
static const int PE_PossiblyEnabled_0[5]= {TR_t2_RT, TR_t3_RT, TR_t7_RT, TR_t8_RT, -1 }; /* t0*/
static const int PE_PossiblyEnabled_1[2]= {TR_t13_RT, -1 }; /* t1*/
static const int PE_PossiblyEnabled_2[2]= {TR_t13_RT, -1 }; /* t2*/
static const int PE_PossiblyEnabled_3[2]= {TR_t14_RT, -1 }; /* t3*/
static const int PE_PossiblyEnabled_4[2]= {TR_t9_RT, -1 }; /* t4*/
static const int PE_PossiblyEnabled_6[2]= {TR_t9_RT, -1 }; /* t6*/
static const int PE_PossiblyEnabled_7[2]= {TR_t13_RT, -1 }; /* t7*/
static const int PE_PossiblyEnabled_8[2]= {TR_t19_RT, -1 }; /* t8*/
static const int PE_PossiblyEnabled_9[3]= {TR_t4_RT, TR_t17_RT, -1 }; /* t9*/
static const int PE_PossiblyEnabled_10[2]= {TR_t19_RT, -1 }; /* t10*/
static const int PE_PossiblyEnabled_11[5]= {TR_t0_RT, TR_t6_RT, TR_t12_RT, TR_t18_RT, -1 }; /* t11*/
static const int PE_PossiblyEnabled_12[2]= {TR_t5_RT, -1 }; /* t12*/
static const int PE_PossiblyEnabled_13[2]= {TR_t5_RT, -1 }; /* t13*/
static const int PE_PossiblyEnabled_14[3]= {TR_t15_RT, TR_t16_RT, -1 }; /* t14*/
static const int PE_PossiblyEnabled_15[2]= {TR_t14_RT, -1 }; /* t15*/
static const int PE_PossiblyEnabled_16[2]= {TR_t13_RT, -1 }; /* t16*/
static const int PE_PossiblyEnabled_17[2]= {TR_t5_RT, -1 }; /* t17*/
static const int PE_PossiblyEnabled_18[2]= {TR_t5_RT, -1 }; /* t18*/
static const int PE_PossiblyEnabled_19[3]= {TR_t1_RT, TR_t10_RT, -1 }; /* t19*/
const int* SPN::PossiblyEnabled[] = {PE_PossiblyEnabled_0, PE_PossiblyEnabled_1, PE_PossiblyEnabled_2, PE_PossiblyEnabled_3, PE_PossiblyEnabled_4, EMPTY_array, PE_PossiblyEnabled_6, PE_PossiblyEnabled_7, PE_PossiblyEnabled_8, PE_PossiblyEnabled_9, PE_PossiblyEnabled_10, PE_PossiblyEnabled_11, PE_PossiblyEnabled_12, PE_PossiblyEnabled_13, PE_PossiblyEnabled_14, PE_PossiblyEnabled_15, PE_PossiblyEnabled_16, PE_PossiblyEnabled_17, PE_PossiblyEnabled_18, PE_PossiblyEnabled_19};

static const int PE_PossiblyDisabled_0[2]= {TR_t18_RT, -1 }; /* t0*/
static const int PE_PossiblyDisabled_1[2]= {TR_t10_RT, -1 }; /* t1*/
static const int PE_PossiblyDisabled_2[2]= {TR_t3_RT, -1 }; /* t2*/
static const int PE_PossiblyDisabled_3[2]= {TR_t2_RT, -1 }; /* t3*/
static const int PE_PossiblyDisabled_4[2]= {TR_t17_RT, -1 }; /* t4*/
static const int PE_PossiblyDisabled_6[2]= {TR_t12_RT, -1 }; /* t6*/
static const int PE_PossiblyDisabled_7[2]= {TR_t8_RT, -1 }; /* t7*/
static const int PE_PossiblyDisabled_8[2]= {TR_t7_RT, -1 }; /* t8*/
static const int PE_PossiblyDisabled_10[2]= {TR_t1_RT, -1 }; /* t10*/
static const int PE_PossiblyDisabled_12[2]= {TR_t6_RT, -1 }; /* t12*/
static const int PE_PossiblyDisabled_15[2]= {TR_t16_RT, -1 }; /* t15*/
static const int PE_PossiblyDisabled_16[2]= {TR_t15_RT, -1 }; /* t16*/
static const int PE_PossiblyDisabled_17[2]= {TR_t4_RT, -1 }; /* t17*/
static const int PE_PossiblyDisabled_18[2]= {TR_t0_RT, -1 }; /* t18*/
const int* SPN::PossiblyDisabled[] = {PE_PossiblyDisabled_0, PE_PossiblyDisabled_1, PE_PossiblyDisabled_2, PE_PossiblyDisabled_3, PE_PossiblyDisabled_4, EMPTY_array, PE_PossiblyDisabled_6, PE_PossiblyDisabled_7, PE_PossiblyDisabled_8, EMPTY_array, PE_PossiblyDisabled_10, EMPTY_array, PE_PossiblyDisabled_12, EMPTY_array, EMPTY_array, PE_PossiblyDisabled_15, PE_PossiblyDisabled_16, PE_PossiblyDisabled_17, PE_PossiblyDisabled_18, EMPTY_array};
...
customDistr(*(new CustomDistr())),pl(16), tr(20) ,Transition(TransArray,TransArray +20),Place(16),ParamDistr(),TransitionConditions(20,0){
    Path ="xp/test_cosmos/gspn1.gspn";
	{ //t0
	abstractBinding bl;
...
bool SPN::IsEnabled(TR_PL_ID t, const abstractBinding &b)const{
	...
	switch (t){
		...
		case 12:	//t12
			...
			if (!(contains(Marking.P->_PL_p4 , 1 ))) return false;
		return true;
		break;
		case 4:	//t4
		case 17:	//t17

			if (!(contains(Marking.P->_PL_p6 , 1 ))) return false;
		return true;
		break;
		case 1:	//t1
		case 10:	//t10
...
{
			int tmpMark_p0 = Marking.P->_PL_p0;
			int tmpMark_p4 = Marking.P->_PL_p4;
			Marking.P->_PL_p0 += 1 ;
			Marking.P->_PL_p4 -= 1 ;
	}
		break;
...
{
			int tmpMark_p0 = Marking.P->_PL_p0;
			int tmpMark_p6 = Marking.P->_PL_p6;
			Marking.P->_PL_p0 += 1 ;
			Marking.P->_PL_p6 -= 1 ;
	}
		break;
